...
If you're migrating to v6 from v5 (or v4, which is the same as v5), check out [the migration guide]. If you're migrating from Reach Router, check out [the migration guide for Reach Router]. If you need to find the code for v5, [it is on the `v5` branch](https://github.com/remix-run/react-router/tree/v5).
